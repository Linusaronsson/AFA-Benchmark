...
METHOD_NAME_MAPPING = {
    ...
    "aaco_marf": "AACO-OC (MARF)",
    "aaco_madt": "AACO-OC (MADT)",
    "aaco_magbt": "AACO-OC (MAGBT)",
    "aaco_malasso": "AACO-OC (MALasso)",
    "aaco_full": "AACO-OC (full train)",
    "aaco_zero_fill": "AACO-OC (block-only train)",
