# """
# Testing configurations for JAFA RL tests with different unmaskers.

# This module provides predefined configurations for testing the JAFA RL pipeline
...
# Usage:
#     from afabench.components.methods.rl.jafa.jafa_testing_configs import get_test_config
...
#     n_samples: int = 10
#     feature_shape: torch.Size = torch.Size(
#         [4]
#     )  # Default 1D features
#     noise_std: float = 0.1
...
# def get_basic_pretrain_config() -> JAFAPretrainConfig:
#     """Get basic pretraining configuration for testing."""
#     return JAFAPretrainConfig(
...
#             dropout=0.0,
#         ),
#         classifier=JAFAClassifierConfig(num_cells=[16, 16]),
#         use_wandb=False,
#     )


# def get_basic_agent_config() -> JAFAAgentConfig:
#     """Get basic agent configuration for testing."""
#     return JAFAAgentConfig(
...
# def get_basic_train_config() -> JAFATrainConfig:
