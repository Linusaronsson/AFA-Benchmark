...
from afabench.components.methods.rl.jafa.reward import (
    get_jafa_reward_fn,
)
...
from afabench.core.config_classes import JAFATrainConfig
...
def method_specific_init(
    ...
    """Initialize config specific to JAFA training."""
...
class JAFARLTrainer(RLTrainer):
    ...
    def _get_pretrained_model_and_optim(
    ...
    ) -> tuple[LitJAFAEmbedderClassifier, optim.Adam]:
        ...
        pretrained_model = cast(
            "LitJAFAEmbedderClassifier", torch_model_bundle.model
        )
