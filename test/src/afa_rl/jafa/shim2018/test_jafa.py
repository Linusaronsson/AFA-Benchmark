# """
# Comprehensive tests for JAFA RL training pipeline with different unmaskers.

# This test suite validates the complete JAFA RL pipeline including:

# 1. **Pretrained Model Tests** (`TestJAFAPretrainedModel`):
#    - Creates and tests JAFA models without actual training
#    - Tests model forward passes with different feature shapes
#    - Validates JAFAAFAPredictFn wrapper functionality
#    - Supports 1D features, 2D features, and image patches

# 2. **Agent Tests** (`TestJAFAAgent`):
#    - Creates JAFA RL agents with proper configurations
#    - Tests agent policy access (exploratory/exploitative)
#    - Validates agent info methods (cheap/expensive info)

# 3. **Environment Tests** (`TestJAFAEnvironment`):
#    - Creates AFAEnv with JAFA reward functions
...
# 4. **Integration Tests** (`TestJAFAIntegration`):
...
# **Test Configurations** are defined in `jafa_testing_configs.py` and include:
...
# These tests ensure that the JAFA method can successfully:
...
# from afabench.components.methods.rl.jafa.jafa_testing_configs import (
#     get_all_test_config_names,
#     get_basic_pretrain_config,
#     get_test_config,
# )
# from afabench.components.methods.rl.jafa.utils import get_jafa_model_from_config
...
# class TestJAFAPretrainedModel:
#     """Test creation and basic functionality of pretrained JAFA models."""
...
#         lit_model = get_jafa_model_from_config(
#             pretrain_config,
#             feature_shape=feature_shape,
#             n_classes=env_config.n_classes,
...
#     def test_jafa_predict_fn(
#         self, device: torch.device, test_config: dict[str, Any]
#     ) -> None:
#         """Test JAFAAFAPredictFn wrapper."""
#         set_seed(42)
...
#         predict_fn = JAFAAFAPredictFn(lit_model)
...
# class TestJAFAAgent:
#     """Test JAFA agent creation and basic functionality."""

#     def test_create_agent(
#         self, device: torch.device, test_config: dict[str, Any]
#     ) -> None:
#         """Test creating a JAFA agent."""
#         set_seed(42)
...
# class TestJAFAEnvironment:
#     """Test JAFA environment integration."""

#     def test_create_environment(
#         self, device: torch.device, test_config: dict[str, Any]
#     ) -> None:
#         """Test creating an environment with JAFA components."""
#         set_seed(42)
