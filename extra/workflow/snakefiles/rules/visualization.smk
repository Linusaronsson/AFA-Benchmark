...
rule plot_eval_perf:
    ...
    input:
        f"extra/output/merged_results/eval_split-{EVAL_DATASET_SPLIT}/eval_perf/{{method_set}}+classifier_type-{{classifier_type}}.parquet",
    output:
        directory(f"extra/output/plot_results/eval_split-{EVAL_DATASET_SPLIT}/eval_perf/{{method_set}}+classifier_type-{{classifier_type}}"),
    resources:
        shell_exec="bash"
    shell:
        """
...
rule plot_eval_actions:
    input:
        f"extra/output/merged_results/eval_split-{EVAL_DATASET_SPLIT}/eval_perf/{{method_set}}+classifier_type-{{classifier_type}}.parquet",
    output:
        directory(f"extra/output/plot_results/eval_split-{EVAL_DATASET_SPLIT}/eval_actions/{{method_set}}+classifier_type-{{classifier_type}}"),
    resources:
        shell_exec="bash"
    shell:
        """
...
rule plot_time:
    ...
    output:
        directory(f"extra/output/plot_results/eval_split-{EVAL_DATASET_SPLIT}/time/"),
    resources:
        shell_exec="bash"
    shell:
        """
